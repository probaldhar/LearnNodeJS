            ...
            var calendarfn = {
                ...
                render:function(date){//传递多个日历参数
                    var date = date,
                        ...
                        this.year = year;
		                this.month = month;
                        for(var i = 0, len = aCal.length; i < len; i++) {
                ...
                drawDate:function(oCal,odate){//绘制日历
                    ...
                    if(def.isSelect){
                        ...
                        selectHtmls.push('<select>');
                        for(var i = 1;i<13;i++)i!=this.month?selectHtmls.push('<option value ="'+i+'">'+i+'</option>'):selectHtmls.push('<option value ="'+i+'" selected>'+i+'</option>');
                        selectHtmls.push('</select>');
                    ...
                    for (var i = 0; i < weekStart; i++)arr.push(0);
