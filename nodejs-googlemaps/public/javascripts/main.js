...
$(document).ready(function() {
    ...
    console.log(MAPAPP.pathName);
});

//Initialize our Google Map
function initialize() {
    var center = new google.maps.LatLng(30.5388043,-87.2357423);
    var mapOptions = {
        zoom: 13,
...
function populateMarkers(dataType) {
    ...
    $.getJSON(apiLoc, function(data) {
    	...
    	//Build the content for InfoWindow
            var content = '<h1 class="mt0"><a href="' + marker.website + '" target="_blank" title="' + marker.shopname + '">' + marker.shopname + '</a></h1><p>' + marker.details + '</p><img src="' + marker.image + '" style="width:50px;height:60px;">';

            // if ( marker.image )
                // var img = '<img src="' + marker.image + '" style="width:50px;height:60px;">';
            // else 
                // var img = "";
